Pod::Spec.new do |s|
  ...
  s.public_header_files = 'JOWCategory/Classes/**、*.h'
  ...
  s.subspec 'JOWMacro' do |ss|
    ss.source_files = 'JOWCategory/Classes/JOWMacro/*.{h,m}'
    ss.public_header_files = 'JOWCategory/Classes/JOWMacro/*.h'
  end
