...
+ (SecKeyRef)addPublicKey:(NSString *)key{
    ...
    data = [JOWRSA stripPublicKeyHeader:data];
    if(!data){
        return nil;
    }
...
+ (SecKeyRef)addPrivateKey:(NSString *)key{
    ...
    // This will be base64 encoded, decode it.
    NSData *data = base64_decode(key);
    data = [JOWRSA stripPrivateKeyHeader:data];
    if(!data){
        return nil;
    }
...
+ (NSString *)jowrea_encryptString:(NSString *)str privateKey:(NSString *)privKey{
    NSData *data = [JOWRSA jowrea_encryptData:[str dataUsingEncoding:NSUTF8StringEncoding] privateKey:privKey];
...
+ (NSData *)jowrea_encryptData:(NSData *)data privateKey:(NSString *)privKey{
    ...
    SecKeyRef keyRef = [JOWRSA addPrivateKey:privKey];
    if(!keyRef){
        return nil;
    }
    return [JOWRSA encryptData:data withKeyRef:keyRef isSign:YES];
}
...
+ (NSString *)jowrea_decryptString:(NSString *)str privateKey:(NSString *)privKey{
    NSData *data = [[NSData alloc] initWithBase64EncodedString:str options:NSDataBase64DecodingIgnoreUnknownCharacters];
    data = [JOWRSA jowrea_decryptData:data privateKey:privKey];
    NSString *ret = [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding];
    return ret;
}
...
+ (NSData *)jowrea_decryptData:(NSData *)data privateKey:(NSString *)privKey{
    ...
    return [JOWRSA decryptData:data withKeyRef:keyRef];
}
...
+ (NSString *)jowrea_encryptString:(NSString *)str publicKey:(NSString *)pubKey{
    NSData *data = [JOWRSA jowrea_encryptData:[str dataUsingEncoding:NSUTF8StringEncoding] publicKey:pubKey];
    NSString *ret = base64_encode_data(data);
    return ret;
}
...
+ (NSData *)jowrea_encryptData:(NSData *)data publicKey:(NSString *)pubKey{
    ...
    SecKeyRef keyRef = [JOWRSA addPublicKey:pubKey];
    if(!keyRef){
        return nil;
    }
    return [JOWRSA encryptData:data withKeyRef:keyRef isSign:NO];
}

+ (NSString *)jowrea_decryptString:(NSString *)str publicKey:(NSString *)pubKey{
    NSData *data = [[NSData alloc] initWithBase64EncodedString:str options:NSDataBase64DecodingIgnoreUnknownCharacters];
    data = [JOWRSA jowrea_decryptData:data publicKey:pubKey];
    NSString *ret = [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding];
    return ret;
}
