...
+ (NSString *)zz_currentDeviceModel
{
    ...
    if ([platform isEqualToString:@"iPhone12,1"])   return @"iPhone 11 (A2111/A2221/A2223)";
    if ([platform isEqualToString:@"iPhone12,3"])   return @"iPhone 11 Pro (A2160/A2215/A2217)";
    if ([platform isEqualToString:@"iPhone12,5"])   return @"iPhone 11 Pro Max (A2161/A2220/A2218)";
